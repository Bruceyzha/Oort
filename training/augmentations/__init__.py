...
class openImg_Transform: # Table 6 
    def __init__(self):


        self.trans_openImg1 = transforms.Compose([
#             transforms.RandomHorizontalFlip(),
...
#             transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))
        ...
        self.trans_openImg2 = transforms.Compose([
#             transforms.RandomHorizontalFlip(),
#             transforms.RandomCrop(size=32,
#                                   padding=int(32*0.125),
#                                   padding_mode='reflect'),
...
class openImg_Transform_t():
    def __init__(self):
        
        self.trans_openImg = transforms.Compose([
            transforms.ToTensor(), 
            transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))
            ])
        
    def __call__(self, x):
        return self.trans_openImg(x)
...
def get_aug(name, train, train_classifier=True):
    ...
    if train==True:
        if name == 'openImg':
            augmentation = openImg_Transform()
        elif name == 'mnist':
        ...
        if name == 'openImg':
            augmentation = openImg_Transform_t()
        elif name == 'mnist':
...
class openImg_Transform_fedmatch: # Table 6 
    def __init__(self):
    ...
    def __call__(self, x):
        x1 = self.trans_openImg1(x) 
        x2 = self.trans_openImg2(x)
        return x2, x1 
...
def get_aug_fedmatch(name, train, train_classifier=True):
    ...
    if train==True:
        if name == "openImg":
            augmentation = openImg_Transform_fedmatch()
        elif name == 'mnist':
